...
const $$CalendariosMesaTriangular = createComponent(($$result, $$props, $$slots) => {
  const metadata = {
    title: "Contacta con nosotros para calendarios de mesa"
  };
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "HeroText", $$HeroText, { "tagline": "calendarios de mesa", "title": "Solicita informaci\xF3n sobre los calidendarios de sobremesa" })} ${renderComponent($$result2, "ContactUs", $$Contact, { "id": "form", "title": "Env\xEDanos tus consultas sobre calendarios", "subtitle": "Estamos aqu\xED para ayudarte a crear el calendario perfecto, desde el dise\xF1o hasta la impresi\xF3n, con opciones personalizadas y soporte en cada paso.", "inputs": [
    {
      type: "text",
      name: "name",
      label: "Nombre"
...
}, "C:/Users/Jordi/Documents/web/calendaris/src/pages/formularios/calendarios-mesa-triangular.astro", void 0);

const $$file = "C:/Users/Jordi/Documents/web/calendaris/src/pages/formularios/calendarios-mesa-triangular.astro";
const $$url = "/formularios/calendarios-mesa-triangular";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$CalendariosMesaTriangular,
  file: $$file,
  url: $$url
