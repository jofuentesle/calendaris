import { a as createComponent, r as renderTemplate, e as addAttribute, o as defineScriptVars, c as createAstro, b as renderComponent, u as unescapeHTML, F as Fragment, s as spreadAttributes, n as renderTransition, f as renderHead, d as renderSlot } from './astro/server_JUoDhWgB.mjs';
import 'kleur/colors';
/* empty css                                           */
import { d as getAsset, U as UI, e as getCanonical, S as SITE, I as I18N, M as METADATA } from './permalinks_DqrWEVgA.mjs';
import 'clsx';
...
}, "C:/Users/Jordi/Documents/web/calendaris/src/components/common/CommonMeta.astro", void 0);

const favIcon = "data:image/x-icon;base64,";

const favIconSvg = new Proxy({"src":"/_astro/favicon.CyhEaTot.svg","width":128,"height":128,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Jordi/Documents/web/calendaris/src/assets/favicons/favicon.svg";
							}
...
const appleTouchIcon = new Proxy({"src":"/_astro/apple-touch-icon.DHIlG7dp.png","width":180,"height":180,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/Jordi/Documents/web/calendaris/src/assets/favicons/apple-touch-icon.png";
							}
...
}, "C:/Users/Jordi/Documents/web/calendaris/src/components/Favicons.astro", void 0);
...
}, "C:/Users/Jordi/Documents/web/calendaris/src/components/CustomStyles.astro", void 0);
...
}, "C:/Users/Jordi/Documents/web/calendaris/src/components/common/ApplyColorMode.astro", void 0);
...
}, "C:/Users/Jordi/Documents/web/calendaris/node_modules/@astrolib/seo/src/AstroSeo.astro", void 0);

const load = async function() {
  let images = void 0;
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/calendarImg.jpg": () => import('./calendarImg_B0ZTh3uo.mjs'),"/src/assets/images/calendarImg2.jpg": () => import('./calendarImg2_BPQ4-Tdk.mjs'),"/src/assets/images/calendarios/ParedEspiral_1.jpg": () => import('./ParedEspiral_1_CuUQH2Au.mjs'),"/src/assets/images/calendarios/ParedEspiral_2.jpg": () => import('./ParedEspiral_2_CJw7rKqh.mjs'),"/src/assets/images/calendarios/ParedEspiral_3.jpg": () => import('./ParedEspiral_3_C2VVgzQ1.mjs'),"/src/assets/images/calendarios/ParedEspiral_4.jpg": () => import('./ParedEspiral_4_DfNj8lqW.mjs'),"/src/assets/images/calendarios/ParedPoster_4.jpg": () => import('./ParedPoster_4_Wqg3yTxA.mjs'),"/src/assets/images/calendarios/ParedRevista_1.jpg": () => import('./ParedRevista_1_CDgJ5as1.mjs'),"/src/assets/images/calendarios/ParedRevista_2.jpg": () => import('./ParedRevista_2_Gr1I1X3t.mjs'),"/src/assets/images/calendarios/ParedRevista_3.jpg": () => import('./ParedRevista_3_CIajY0Ls.mjs'),"/src/assets/images/calendarios/ParedRevista_4.jpg": () => import('./ParedRevista_4_Cmswdms2.mjs'),"/src/assets/images/calendarios/SobremesaEspiral_1.jpg": () => import('./SobremesaEspiral_1_DZynGlOi.mjs'),"/src/assets/images/calendarios/SobremesaEspiral_2.jpg": () => import('./SobremesaEspiral_2_Ddp3N2XU.mjs'),"/src/assets/images/calendarios/SobremesaEspiral_3.jpg": () => import('./SobremesaEspiral_3_BCVr5JkQ.mjs'),"/src/assets/images/calendarios/SobremesaEspiral_4.jpg": () => import('./SobremesaEspiral_4_R-LiVn3c.mjs'),"/src/assets/images/calendarios/SobremesaHome.jpg": () => import('./SobremesaHome_pQPg94s6.mjs'),"/src/assets/images/calendarios/SobremesaTriangular_1.jpg": () => import('./SobremesaTriangular_1_DbFJd2Ic.mjs'),"/src/assets/images/calendarios/SobremesaTriangular_2.jpg": () => import('./SobremesaTriangular_2_BYnt7wzx.mjs'),"/src/assets/images/calendarios/SobremesaTriangular_3.jpg": () => import('./SobremesaTriangular_3_CVtpawr-.mjs'),"/src/assets/images/calendarios/SobremesaTriangular_4.jpg": () => import('./SobremesaTriangular_4_CNAG9gFd.mjs'),"/src/assets/images/calendarios/Triangular_1.jpg": () => import('./Triangular_1_5j4G1b6u.mjs'),"/src/assets/images/calendarios/Triangular_2.jpg": () => import('./Triangular_2_CC49wzxs.mjs'),"/src/assets/images/calendarios/Triangular_3.jpg": () => import('./Triangular_3_DQ4y2ap2.mjs'),"/src/assets/images/calendarios/calendarDesktop.png": () => import('./calendarDesktop_C8VETm_N.mjs'),"/src/assets/images/calendarios/calendariP.png": () => import('./calendariP_yLUxmkr6.mjs'),"/src/assets/images/calendarios/slide1.jpg": () => import('./slide1_Dy1lrvfd.mjs'),"/src/assets/images/calendarios/slide2.jpg": () => import('./slide2_YhrVCGTt.mjs'),"/src/assets/images/calendarios/slide2_2.jpg": () => import('./slide2_2_DKrBmSc9.mjs'),"/src/assets/images/calendarios/slide3.jpg": () => import('./slide3_X8OqEGb_.mjs'),"/src/assets/images/forms/a5.png": () => import('./a5_OpgY-ZOM.mjs'),"/src/assets/images/forms/a6.png": () => import('./a6_CVCQYOym.mjs'),"/src/assets/images/mesa/SobremesaEspiral.jpg": () => import('./SobremesaEspiral_BgOQ8_Ke.mjs'),"/src/assets/images/mesa/SobremesaEspiral1.jpg": () => import('./SobremesaEspiral1_BNQRH_aV.mjs'),"/src/assets/images/mesa/SobremesaEspiral2.jpg": () => import('./SobremesaEspiral2_DJz2fsjO.mjs'),"/src/assets/images/mesa/SobremesaEspiral3.jpg": () => import('./SobremesaEspiral3_fbgIhLyI.mjs'),"/src/assets/images/mesa/SobremesaHome.jpg": () => import('./SobremesaHome_CHms3cs3.mjs'),"/src/assets/images/mesa/SobremesaTriangular.jpg": () => import('./SobremesaTriangular_CkCNYvS_.mjs'),"/src/assets/images/mesa/SobremesaTriangular1.jpg": () => import('./SobremesaTriangular1_BNesPwGv.mjs'),"/src/assets/images/mesa/SobremesaTriangular2.jpg": () => import('./SobremesaTriangular2_Ceqw9F-D.mjs'),"/src/assets/images/mesa/SobremesaTriangular3.jpg": () => import('./SobremesaTriangular3_BD5qMvaV.mjs'),"/src/assets/images/pared/Images _ Docs_files/houston-happy.fP8mBnGj.webp": () => import('./houston-happy.fP8mBnGj_CCCBUHHo.mjs'),"/src/assets/images/pared/Images _ Docs_files/houston_chef.webp": () => import('./houston_chef_Ct1hsU3R.mjs'),"/src/assets/images/pared/Images _ Docs_files/houston_omg.CKiB_MJZ_wdOqF.webp": () => import('./houston_omg.CKiB_MJZ_wdOqF_C0m94ML8.mjs'),"/src/assets/images/pared/ParedEspiral.jpg": () => import('./ParedEspiral_DGUvHMiJ.mjs'),"/src/assets/images/pared/ParedEspiral1.jpg": () => import('./ParedEspiral1_CUTanU0x.mjs'),"/src/assets/images/pared/ParedEspiral2.jpg": () => import('./ParedEspiral2_se_jvnni.mjs'),"/src/assets/images/pared/ParedEspiral3.jpg": () => import('./ParedEspiral3_D2PLJM-i.mjs'),"/src/assets/images/pared/ParedHome.jpg": () => import('./ParedHome_BGHOfXOP.mjs'),"/src/assets/images/pared/ParedRevista.jpg": () => import('./ParedRevista_Dwds71xJ.mjs'),"/src/assets/images/pared/ParedRevista1.jpg": () => import('./ParedRevista1_D8JQFH15.mjs'),"/src/assets/images/pared/ParedRevista2.jpg": () => import('./ParedRevista2_BMgbi71k.mjs'),"/src/assets/images/pared/ParedRevista3.jpg": () => import('./ParedRevista3_D_N0eDUh.mjs')});
  } catch (error) {
  }
  return images;
};
...
}, "C:/Users/Jordi/Documents/web/calendaris/src/components/common/Metadata.astro", void 0);
...
}, "C:/Users/Jordi/Documents/web/calendaris/src/components/common/SiteVerification.astro", void 0);
...
}, "C:/Users/Jordi/Documents/web/calendaris/node_modules/@astrolib/analytics/src/GoogleAnalytics.astro", void 0);

const $$Analytics = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${null}`;
}, "C:/Users/Jordi/Documents/web/calendaris/src/components/common/Analytics.astro", void 0);
...
}, "C:/Users/Jordi/Documents/web/calendaris/src/components/common/BasicScripts.astro", void 0);
...
}, "C:/Users/Jordi/Documents/web/calendaris/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html${addAttribute(language, "lang")}${addAttribute(textDirection, "dir")} class="2xl:text-[20px]"${addAttribute(renderTransition($$result, "smooz4hq"), "data-astro-transition-scope")}> <head>${renderComponent($$result, "CommonMeta", $$CommonMeta, {})}${renderComponent($$result, "Favicons", $$Favicons, {})}${renderComponent($$result, "CustomStyles", $$CustomStyles, {})}${renderComponent($$result, "ApplyColorMode", $$ApplyColorMode, {})}${renderComponent($$result, "Metadata", $$Metadata, { ...metadata })}${renderComponent($$result, "SiteVerification", $$SiteVerification, {})}${renderComponent($$result, "Analytics", $$Analytics, {})}<!-- Comment the line below to disable View Transitions -->${renderComponent($$result, "ViewTransitions", $$ViewTransitions, {})}${renderHead()}</head> <body class="antialiased text-default bg-page tracking-tight"> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "BasicScripts", $$BasicScripts, {})}  </body> </html>`;
}, "C:/Users/Jordi/Documents/web/calendaris/src/layouts/Layout.astro", "self");
