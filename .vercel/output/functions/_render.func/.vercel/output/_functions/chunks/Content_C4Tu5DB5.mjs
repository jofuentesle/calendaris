import { c as createAstro, a as createComponent, r as renderTemplate, b as renderComponent, m as maybeRenderHead, e as addAttribute, u as unescapeHTML, F as Fragment } from './astro/server_JUoDhWgB.mjs';
import 'kleur/colors';
...
const $$Content = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "WidgetWrapper", $$WidgetWrapper, { "id": id, "isDark": isDark, "containerClass": `max-w-7xl mx-auto ${isAfterContent ? "pt-0 md:pt-0 lg:pt-0" : ""} ${classes?.container ?? ""}`, "bg": bg }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Headline", $$Headline, { "title": title, "subtitle": subtitle, "tagline": tagline, "classes": {
    ...
    icon: "flex h-7 w-7 items-center justify-center rounded-full bg-primary dark:bg-green-700 text-gray-50 p-1",
...
}, "C:/Users/Jordi/Documents/web/calendaris/src/components/widgets/Content.astro", void 0);
